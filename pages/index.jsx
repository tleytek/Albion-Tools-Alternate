...
const About = () => (
  <div className="about">
    ...
    <p>
      ...
      {' '}
      <a href="http://albionassistant.com/Default.aspx">Albion Assistant</a>
      {' '}
and is quite frankly an
    ...
    <p>
      ...
      {' '}
      <a href="https://github.com/BroderickHyman/albiondata-client/releases">Client</a>
      {' '}
as its
